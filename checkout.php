        ...
        <div class="container">
            ...
            <div class="checkout-content">
                ...
                <form class="checkout-form active" id="shipping-form">
                    ...
                    <div class="form-group" style="margin-top: 25px;">
                        <input type="checkbox" id="save-address" style="margin-right: 10px;">
                        <label for="save-address" style="display: inline; font-weight: normal;">Save this information for next time</label>
                    </div>
            ...
            <form class="checkout-form" id="review-form" style="display: none;">
                ...
                <div class="form-group" style="margin: 25px 0;">
                    <input type="checkbox" id="terms-agree" required style="margin-right: 10px;">
                    <label for="terms-agree" style="display: inline; font-weight: normal;">I agree to the <a href="#" style="color: #2a5c8d;">Terms and Conditions</a> and <a href="#" style="color: #2a5c8d;">Privacy Policy</a></label>
...
// Initialize Stripe
const stripe = Stripe('pk_test_51Rvl7rRiB8E6Od2OC3RWdJeSeYdOjNmMaplRhfYzzk9DfZmGZNSXicKE30KtSVs7V5pFTVilTFvY1SDSKQaWgSAi00JGTyAq6n');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-next-step').forEach(btn => {
        btn.addEventListener('click', function(e) {
            e.preventDefault();
            console.log('Continue to Payment button clicked, current step:', currentStep);
    ...
    function updateReviewInformation() {
        ...
        if (paymentMethod) {
            if (paymentMethod.value === 'credit-card') {
                paymentInfo = 'Credit/Debit Card ending in ••••';
    ...
    document.getElementById('review-form').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            alert('Order placed successfully! Thank you for your purchase. A confirmation email has been sent.');
            ...
            const orderDataEncoded = encodeURIComponent(JSON.stringify(orderDataForConfirmation));
