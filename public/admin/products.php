        ...
        <main class="admin-main">
            ...
            <div class="filters-section">
                ...
                <form method="GET" class="filters-form">
                    ...
                    <div class="form-group">
                        ...
                        <a href="products.php" class="btn btn-secondary" style="margin-left: 10px;">Clear</a>
                    </div>
                </form>
            </div>
            ...
            <form method="POST" id="bulkForm">
                <div class="bulk-actions">
                    ...
                    <button type="submit" name="bulk_delete" class="btn btn-danger" onclick="return confirm('Delete selected products?')">Delete Selected</button>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="product-edit.php?id=<?php echo $product["id']; ?>" class="btn btn-secondary">Edit</a>
