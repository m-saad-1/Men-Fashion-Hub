...
// Bulk status update - Update all filtered orders
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['bulk_update'])) {
    $new_status = $_POST['bulk_status'];

    if (!empty($new_status)) {
        // Build the same WHERE clause as used for displaying orders
        $conditions = [];
        $params = [];
        ...
        $stmt = $conn->prepare("UPDATE orders o JOIN users u ON o.user_id = u.id SET o.status = ?, o.updated_at = NOW() $where_clause");
        $stmt->execute(array_merge([$new_status], $params));
    }

    header("Location: admin-orders.php?page=$page&bulk_updated=true");
    exit();
}
?>
...
<head>
    ...
    <style>
        ...
        @media (max-width: 1200px) {
            ...
            /* Keep bulk actions unchanged - preserve original layout */
            .bulk-actions {
                display: flex;
                gap: 15px;
                align-items: center;
...
<body>
    ...
    <div class="admin-container">
        ...
        <main class="admin-main">
            ...
            <?php if (isset($_GET['bulk_updated']) && $_GET['bulk_updated'] == 'true'): ?>
                <div class="alert alert-success">
            ...
            <div class="filters-section">
                ...
                <form method="GET" class="filters-form">
                    ...
                    <div class="form-group">
                        ...
                        <a href="orders.php" class="btn btn-secondary" style="margin-left: 10px;">Clear</a>
                    </div>
                </form>
            </div>
            ...
            <div class="bulk-actions">
                <form method="POST" style="display: inline-block;">
                    ...
                    <select name="bulk_status" required style="padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; background: white; font-size: 14px; color: #333; min-width: 150px;">
                    ...
                    <button type="submit" name="bulk_update" class="btn btn-primary" onclick="return confirm('Update all filtered orders?')">Update All Filtered</button>
                </form>
            </div>
    ...
    <script>
        ...
        // Bulk update functionality (no select all needed)
