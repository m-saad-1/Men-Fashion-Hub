...
<body>
            ...
            <div class="auth-container">
                ...
                <form class="auth-form active" id="login-form">
                    ...
                    <div class="social-login">
                        ...
                        <div class="social-buttons">
                            <a href="../../app/api/auth/google_login.php" class="social-btn google" style="flex: unset; width: 100%;"><i class="fab fa-google"></i> Continue with Google</a>
                        </div>
                    </div>
                ...
                <form class="auth-form" id="register-form">
                    ...
                    <div class="social-login">
                        <p>Or sign up with</p>
                        <div class="social-buttons">
                            <a href="../../app/api/auth/google_login.php?intent=register" class="social-btn google" style="flex: unset; width: 100%;"><i class="fab fa-google"></i> Sign up with Google</a>
                        </div>
                    </div>
                    <div class="auth-footer">
 ...
 <?php include '../../app/views/partials/footer.php'; ?>
    ...
    <script>
// User Authentication System for LOGIN PAGE - FIXED VERSION
// User Authentication System for LOGIN PAGE
const auth = {
    apiBaseUrl: '../../app/api',
    
    // ADD THIS METHOD TO LOGIN PAGE AUTH OBJECT
    ...
    checkAuth: async function() {
        try {
            ...
            // Check if we have a logout parameter
            const urlParams = new URLSearchParams(window.location.search);
            if (urlParams.has('logout')) {
                console.log('Logout detected, clearing local data');
                this.clearClientData(); // FIXED: Now this method exists
                return;
            }
    ...
    handlePasswordReset: async function() {
        ...
        try {
            ...
            // Make API request
            const response = await fetch(`${this.apiBaseUrl}/auth/reset_password.php`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
