                ...
                <form class="checkout-form" id="payment-form" style="display: none;">
                    ...
                    <div class="payment-option">
                        ...
                        <div class="payment-details" id="cash-delivery-details">
                            <p style="margin-bottom: 15px;">Pay with cash upon delivery. An additional Rs 5.00 fee will be charged for this service.</p>
                ...
                <div class="review-section" style="margin-bottom: 25px;">
                    ...
                    <div class="order-summary">
                        <div class="summary-row" style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            ...
                            <div class="summary-value" id="summary-subtotal">Rs 0.00</div>
                        </div>
                        <div class="summary-row" style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                        ...
                        <div class="summary-row" id="payment-fee-row" style="display: none; justify-content: space-between; margin-bottom: 10px;">
                            ...
                            <div class="summary-value" id="payment-fee-value">Rs 5.00</div>
                        </div>
                        <div class="summary-row total" style="display: flex; justify-content: space-between; margin-top: 15px; padding-top: 15px; border-top: 1px solid #eee; font-weight: 600; font-size: 18px;">
                            ...
                            <div class="summary-value" id="summary-total">Rs 0.00</div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // This function doesn't exist, rely on auth.js methods instead if needed
    ...
    function updateReviewInformation() {
        ...
        if (paymentMethod) {
            if (paymentMethod.value === 'credit-card') {
                ...
                paymentInfo = 'Pay on Delivery (+Rs 5.00 fee)';
            }
        }
    ...
    async function removePurchasedItemsFromDatabase(selectedItems) {
        try {
            const response = await fetch(`${API_BASE}/cart/remove_purchased_items.php`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.getElementById('review-form').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (saveAddressChecked && currentUserData) {
                try {
                    await fetch(`${API_BASE}/users/save_addresses.php`, {
                        method: 'POST',
                        ...
                        body: JSON.stringify({
                            ...
                            street: shippingAddressObj.address + (shippingAddressObj.address2 ? ' ' + shippingAddressObj.address2 : ''),
...
async function fetchUserData() {
    try {
        const response = await fetch(`${API_BASE}/auth/validate_session.php`, {
            credentials: 'include'
        });
