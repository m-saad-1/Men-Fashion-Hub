...
.btn-small {
    ...
    font-size: 0.9rem;
        ...
        .product-title {
            font-size: 1rem;
            margin-bottom: -5px; /* Further reduced from 5px to 2px */
            font-weight: 600;
            line-height: 1.3;
        }
        ...
        .product-options {
            display: flex;
            flex-direction: column;
            gap: -10px; /* Reduced from 4px to 2px */
            margin-top: -25px; /* Further reduced from 3px to 1px */
        }
        ...
        @media (max-width: 768px) {
            ...
            .product-options {
                margin-top: px; /* Reduced for mobile */
            }
                ...
                <div class="cart-summary">
                    ...
                    <div class="summary-table">
                        <div class="summary-row">
                            ...
                            <div class="summary-value" id="cartSubtotal">Rs 0.00</div>
                        </div>
                        <div class="summary-row">
                            ...
                            <div class="summary-value">
                                <div class="shipping-options">
                                    ...
                                    <div class="shipping-option">
                                        ...
                                        <label for="express-shipping">Express Shipping: Rs 9.99</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="summary-row">
                            ...
                            <div class="summary-value total" id="cartTotal">Rs 0.00</div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize cart
    initializeCart().then(() => {
        // Update cart display every second for real-time updates
        ...
        if (auth.currentUser) {
            ...
            try {
                ...
                if (data.status === 'success') {
                    // Update cart from database, mapping product_id to id
                    cart = data.cart.map(item => ({
                        id: parseInt(item.product_id),
                        cart_item_id: item.id, // Store actual cart item ID just in case
                        title: item.title,
    ...
    function updateCartDisplay() {
        // Merge items with same product but different options
    ...
    if (confirmRemoveBtn) {
        confirmRemoveBtn.addEventListener('click', async function() {
            if (itemToRemoveIndex !== null) {
                ...
                // Remove item from both cart and database
                const response = await fetch(`${API_BASE}/remove_cart_item.php`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                    body: JSON.stringify({
                        product_id: cart[itemToRemoveIndex].id
                    })
                });
