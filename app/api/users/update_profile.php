...
$name = isset($data['name']) ? $data['name'] : (isset($data['first_name']) ? trim($data['first_name'] . ' ' . ($data['last_name'] ?? '')) : null);
...
try {
    ...
    $password = isset($data['password']) ? $data['password'] : (isset($data['new_password']) ? $data['new_password'] : null);
