    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="shop.html?category=new-arrivals" class="btn btn-outline">New Arrivals</a>
            </div>
        </div>
  ...
  <section class="featured-categories">
        <div class="container">
            ...
            <div class="category-grid">
                ...
                <a href="shop.html?category=footwear" class="category-card">
    ...
    <section class="promo-banner">
        <div class="promo-content">
            ...
            <a href="shop.html?category=sale" class="btn-outline">Shop Sale</a>
        </div>
    </section>
...
<?php include 'footer.html'; ?>
    ...
    <!-- Product Modal (will be added by JavaScript) -->
<script>
    // Shopping Cart
